...
class StoryEvaluationRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "story_id",
            "clarity_agentic_story",
            "clarity_human_written_story",
            "trustworthiness_agentic_story",
            "trustworthiness_human_written_story",
            "evidence_agentic_story",
            "evidence_human_written_story",
            "insightfulness_agentic_story",
            "insightfulness_human_written_story",
            "engagement_agentic_story",
            "engagement_human_written_story",
            "preferred_story",
            "feedback",
        ]
