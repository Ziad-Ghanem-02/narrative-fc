...
const stats = [
  ["96", "Years of World Cups", "1930–2026", Trophy], ["23", "Tournaments", "Men's editions", Waves],
  ["1,352", "Matches", "All stages", ChartNoAxesCombined], ["88", "Teams", "From six continents", Users]
] as const;
const ideas = [
...
export default function Home(){return <main className="page-shell">
    ...
    <div className="container-page relative z-10 flex min-h-[680px] items-center py-16">
      <div className="grid w-full items-center gap-10 lg:grid-cols-[1.15fr_.85fr]">
        <div><div className="mb-6 flex items-center gap-2 text-xs font-bold tracking-[.18em]"><Trophy size={18} className="text-[#efbc42]"/> RISE OF UNDERDOGS</div>
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-slate-300">Explore 96 years of World Cup history to see how the gap between traditional giants and emerging teams is shrinking.</p>
        ...
        <div className="relative hidden min-h-[390px] items-end justify-center lg:flex">
          <div className="hero-trophy absolute right-[22%] top-0">
            <img src="/world-cup-trophy.png" alt="FIFA World Cup Trophy" />
          </div>
          <img className="hero-football absolute bottom-0 left-[5%]" src="/football.png" alt="Football" />
        </div>
      </div>
    </div>
  </section>
  ...
  <section className="container-page py-20"><div className="text-center"><h2 className="text-xl font-bold uppercase tracking-wider">Football is about to change</h2><div className="title-line"/></div>
